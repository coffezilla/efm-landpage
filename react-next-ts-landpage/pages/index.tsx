		...
		<div>
			...
			<main>
				...
				<section className="container py-3 py-md-4">
					...
					<div className="row justify-content-center justify-content-md-between pb-0 pb-md-5">
						<div className="col-10 col-md-3 pb-3 pb-md-0">
							<CardMid
								cover="/efut-manager-landpage/images/f1.jpg"
								title="VÁRIAS LIGAS"
						...
						<div className="col-10 col-md-3 pb-3 pb-md-0">
							<CardMid
								cover="/efut-manager-landpage/images/f4.jpg"
								title="JOGO GRÁTIS"
						...
						<div className="col-10 col-md-3 pb-3 pb-md-0">
							<CardMid
								cover="/efut-manager-landpage/images/f3.jpg"
						...
						<div className="col-10 col-md-3 pb-0 pb-md-0">
							<CardMid
								cover="/efut-manager-landpage/images/f2.jpg"
								title="+100 EQUIPES"
				...
				<BannerSecondary
					...
					image="/efut-manager-landpage/images/cards.png"
					background="/efut-manager-landpage/images/field.jpg"
					type="BANNER_IMAGE"
				/>

				<section className="container py-3 py-md-4">
					<HeaderSection
						icon="/efut-manager-landpage/images/icon-efut-xl.png"
				...
				<BannerSecondary
					...
					background="/efut-manager-landpage/images/banner-secondary.jpg"
					image="/efut-manager-landpage/images/banner-screenshots.png"
					type="BANNER_MUTED"
				/>
